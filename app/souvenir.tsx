    ...
    return (
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Your Souvenir</Text>
        </View>
        ...
        <View style={styles.videoContainer}>
          ...
          <Text style={styles.videoDescription}>
            Your beautiful memories compiled into a heartfelt video
          </Text>
        </View>
        ...
        >
          ...
          <Text style={styles.createAnotherText}>Create Another Style</Text>
        </TouchableOpacity>
      </LinearGradient>
    );
  }
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Generate Souvenir</Text>
      </View>

      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.intro}>
          <Text style={styles.introTitle}>Create Your Memory Video</Text>
          <Text style={styles.introSubtitle}>
            Choose a style to create a beautiful montage of your event memories
          </Text>
        </View>
        ...
        {isGenerating ? (
          <View style={styles.generatingContainer}>
            <View style={styles.progressContainer}>
              <Text style={styles.progressTitle}>Creating Your Souvenir...</Text>
          ...
          <View style={styles.stylesContainer}>
            <Text style={styles.stylesTitle}>Choose a Style</Text>
      ...
      {!isGenerating && selectedStyle && (
        <View style={styles.bottomAction}>
          ...
          >
            <Heart color="white" size={20} />
            <Text style={styles.generateButtonText}>Generate My Souvenir</Text>
          </TouchableOpacity>
        </View>
      )}
    </LinearGradient>
